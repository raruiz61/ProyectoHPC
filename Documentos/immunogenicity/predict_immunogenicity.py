...
class Prediction():
    ...
    def validate(self, options, args):
		...
		#print(amino_acid)
                if amino_acid.upper() in "1234567890.":
			peptide=''
	        elif not amino_acid.upper() in "ACDEFGHIKLMNPQRSTVWY":
...
#                     raise ("Error: Please make sure you are entering in correct amino acids.")
	    ...
	    #print(result)
	    if float(result[2]) > 0.001:
	            #print ','.join(result)
		    print ''.join(result[0])+' '+''.join(result[2])
		    #resultados.append([result[0],result[1]])

	#print(sys.argv[1])
	if sys.argv[1]=='':
		print("Vacio")
	#'''
	if sys.argv[1]=="/home/proyecto/Documentos/resultados/resultadomhci.txt":
		comando="/home/proyecto/Documentos/immunogenicity/predict_immunogenicity.py /home/proyecto/Documentos/resultados/resultadomhcii.txt >> /home/proyecto/Documentos/resultados/resultadoimmunogenicity.txt"
		resultado = os.system(comando)	
	elif sys.argv[1]=="/home/proyecto/Documentos/resultados/resultadomhcii.txt":
		comando="python /home/proyecto/Documentos/bcell/predict_bcell.py -m Kolaskar-Tongaonkar /home/proyecto/Documentos/resultados/resultadoimmunogenicity.txt > /home/proyecto/Documentos/resultados/resultadocbell.txt"
		resultado = os.system(comando)
	else:
		print("Error: Source file dont found.")		
		sys.exit(0)
...
"""
    ...
    def main(self):
        parser = OptionParser(usage="usage: %prog [options] input", version="%prog 1.0")
